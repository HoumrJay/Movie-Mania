...
public class FragmentRating extends Fragment {
    ...
    private static final String ORDER_BY_RATING_URL = "http://api.themoviedb.org/3/movie/top_rated?api_key=";
    ...
    private class PopularMoviesAsyncTask extends AsyncTask<URL, Void, ArrayList<MovieModel>> {
        ...
        protected ArrayList<MovieModel> doInBackground(URL... urls) {
            ...
            movieUrl = createMovieUrl(ORDER_BY_RATING_URL + POPULAR_MOVIES_API_KEY);
