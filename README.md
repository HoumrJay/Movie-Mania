# Movie Mania
<p>Movie Mania is an Android application developed as a student project for the Udacity Android Nanodegree Course. Organized grid layouts in the app provide users with lists of the most popular and top rated movies on www.themoviedb.com. A simple click on a movie poster redirect the user to the detail page that contains the title, release date, movie rating, plot, reviews and list of trailers that can the user either watch (simple click) or share (long click).</p>
